...
class Ui_ExportOptDlg(object):
    ...
    def retranslateUi(self, ExportOptDlg):
        ...
        self.langCmbBox.setItemText(5, _translate("ExportOptDlg", "EXPANDED TURN PROGRAM"))
        self.langCmbBox.setItemText(6, _translate("ExportOptDlg", "EXPANDED MILL PROGRAM"))
