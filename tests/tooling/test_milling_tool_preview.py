...
from app.ui.plot.milling_tool_preview import TOOL_ALPHA, MillingToolPreviewItem
from app.ui.plot.tool_library_preview import ToolLibraryPreview, ToolLibraryPreviewPane
...
def test_turning_drill_library_preview_uses_shared_turning_geometry(qt_app, monkeypatch):
    ...
    monkeypatch.setattr("app.ui.plot.tool_library_preview.display_tool_geometry", fake_geometry)
