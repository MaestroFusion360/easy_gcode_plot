...
from app.ui.generated.editors.tool_library_preview import Ui_ToolLibraryPreviewPane
...
class ToolLibraryPreviewPane(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # The viewport and zoomable preview must use the same palette role.
        # Otherwise zooming out exposes a Base-colored tile on top of the
        # Window-colored scroll-area background in native dark mode.
        viewport = self.scrollArea.viewport()
        viewport.setBackgroundRole(QPalette.ColorRole.Window)
        viewport.setAutoFillBackground(True)
        self.preview.setBackgroundRole(QPalette.ColorRole.Window)
