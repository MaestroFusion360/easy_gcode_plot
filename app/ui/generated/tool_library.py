...
class Ui_ToolLibraryDialog(object):
    def setupUi(self, ToolLibraryDialog):
        ...
        ToolLibraryDialog.setStyleSheet(u"QGroupBox { border: none; margin-top: 12px; }\n"
"QGroupBox::title { subcontrol-origin: margin; left: 4px; padding: 0 2px; font-weight: 600; }")
